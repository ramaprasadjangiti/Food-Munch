...
<body>
    <div class="navbar">
        ...
        <table class="right">
            <tr>
                <td>add Restaurant</td>
                <!-- navagate to login page -->
                <td><a href="Login.jsp" style="color: white; text-decoration: none;">Login</a></td> 
                <!-- navigate to signup page -->
                <td><a href="Signup.jsp" style="color: white; text-decoration: none;">Signup</a></td>
            </tr>
        </table>
    </div>
    ...
    <%--to get all the restaurants from the attribute and to display in the browser--%>
        <%
        ...
        %>
                   <div class="restaurant-card" onclick="displayLoginMessage()">
